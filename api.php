<?php
// MATIKAN KEBOCORAN HTML ERROR DARI PHP
error_reporting(0);
...
function saveBase64Image($base64Data, $nip, $prefix) {
    ...
    if(count($image_parts) < 2) return $base64Data; 
...
try {
    switch ($action) {
        ...
        case 'adminLogin':
            ...
            if (isset($conf['ADMIN_USERNAME']) && $userReq === $conf['ADMIN_USERNAME'] && $passReq === $conf['ADMIN_PASSWORD']) {
        ...
        case 'absen':
            ...
            if ($type === 'masuk') {
                ...
                $jamNormal = $stmtConf ? $stmtConf->fetchColumn() : '08:00:00';
